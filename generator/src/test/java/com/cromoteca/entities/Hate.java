...
public class Hate {
  ...
  private final Equipment<Series<Access<Blouse<Honey<Strenght<Cap>>>>>, Double, Background>
      childhood;
  ...
  public Hate(
      Integer strenght,
      Equipment<Series<Access<Blouse<Honey<Strenght<Cap>>>>>, Double, Background> childhood) {
  ...
  @Nonnull
  public Equipment<Series<Access<Blouse<Honey<Strenght<Cap>>>>>, Double, Background>
      getChildhood() {
    return childhood;
  }
}
