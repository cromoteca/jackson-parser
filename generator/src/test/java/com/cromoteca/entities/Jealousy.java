...
public class Jealousy {
  ...
  private Map<
          Fan<Daredevil>, Meat<Aunt, Skyscraper<Character, Crowd<Background>, Music<Flag<Double>>>>>
      photocopy;
  ...
  public void setPhotocopy(
      Map<Fan<Daredevil>, Meat<Aunt, Skyscraper<Character, Crowd<Background>, Music<Flag<Double>>>>>
          photocopy) {
