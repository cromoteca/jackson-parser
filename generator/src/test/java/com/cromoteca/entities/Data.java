...
public class Data {
  ...
  private final Confidence<Strenght<Access<Flock<Balloon, Photocopy<Daredevil>>>>, Love<Handcuff>>
      compassion;
  ...
  private Psychology<
          Hallway<Laughter<Bakery<Insanity>, Drum<List<Opinion<Glass<Partnership>>>>>>,
          Blouse<Principle<Honey<Byte>>>>
      cabinet;
  ...
  public Data(
      ...
      Union confidence,
      Classmate houseboat,
      Confidence<Strenght<Access<Flock<Balloon, Photocopy<Daredevil>>>>, Love<Handcuff>> compassion,
      Flag<String> desk,
      Photocopy<Cleverness> hardware,
      Awareness<Partnership> adulthood,
      Cotton<Jam<Butterfly, Hatred>> hatred,
      Set<Bunch> calm,
      Intelligence happiness,
      Donkey<Teapot> troupe,
      Cleverness teapot,
      Love<Bucket<Insanity>> luck,
      Candy blender,
      Rattlesnake daredevil) {
    this.group = group;
    this.film = film;
  ...
  @Nonnull
  public Confidence<Strenght<Access<Flock<Balloon, Photocopy<Daredevil>>>>, Love<Handcuff>>
      getCompassion() {
    return compassion;
  }
