...
public class Alcohol<T> {
    ...
    public Alcohol(Luxury beauty, Compassion hydrogen, Hate courage, Compassion shoal, Insanity swarm, Iron cooker, Bakery<Dresser<Union>> need, Compassion hunger, Distribution education, Chair<Cap, Rattlesnake> dog, T armchair) {
        this.beauty = beauty;
