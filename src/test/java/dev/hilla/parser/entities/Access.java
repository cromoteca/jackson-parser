...
public class Access<T> {
    ...
    public Access(Map<Hallway<Detective>, Float> cap, Set<BigDecimal> glass, List<Equipment<List<Character>, Detective, List<Series<Detective>>>> compassion, Byte iron, Principle<Long> adulthood) {
        this.cap = cap;
        this.glass = glass;
