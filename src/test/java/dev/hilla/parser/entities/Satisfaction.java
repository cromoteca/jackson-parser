...
public class Satisfaction {
    ...
    public Satisfaction(String pancake, Short intelligence, Integer alcohol, Principle<Principle<Loneliness>> coffee, Character blood, Float meat, Series<Detective> education, BigInteger childhood, Detective bunch, Float shower, List<Series<Orchestra>> victory, String footprint, Boolean golf, Principle<List<Double>> fall) {
