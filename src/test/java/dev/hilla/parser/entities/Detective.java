...
public class Detective {
    ...
    public Detective(Double pancake, Float ball, Double sanity, Pack opinion, Set<Short> airline, Long psychology, Butterfly glass, Boolean sunshine, Byte blood, Butterfly need, Series<Loneliness> education, Series<Loneliness> confidence, Float light, BigDecimal bunch, Byte shower, BigInteger victory, Loneliness clothing, Love<Principle<Double>> bakery, Integer tolerance, Integer photocopy, Character cap, List<Long> joy, Byte daredevil) {
