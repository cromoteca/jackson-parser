...
public class Guest<T, U> {
    ...
    public Guest(Hatred bed, Myself donkey, Pack dirt, T board, Long childhood, Skyscraper<Raincoat<Cleverness, Botany>, Cooker, Bed> fish, Shoal<Horsefly, Beans, Equipment<Detective, Photocopy<Partnership>, Cheeks>> flock) {
        this.bed = bed;
        this.donkey = donkey;
        this.dirt = dirt;
        this.board = board;
