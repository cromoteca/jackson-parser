...
public class Jam<T, U> {
    ...
    public Jam(Character opinion, Float photocopy, Union detective, Series<Bakery<Rattlesnake>> thunderstorm, Background football, Bakery<Cap> awe, Hate heap, Homework stack, Charlie industry, Luxury duty, Teapot compassion, Pile countdown, Blouse<Tiredness> myself, Strenght<Hatred> hatred) {
