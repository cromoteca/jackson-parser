...
public class Balloon {
    ...
    public Balloon(Confidence<Butterfly, Homework> notebook, Boat<Psychology<Clothing, Equipment<Airline, Pack, String>>> donkey, List<Cupboard> jewelry, Distribution overdue, Byte honey, Love<Detective> teapot, Love<Clothing> desktop, Chaos nurture, Long houseboat, Detective innocence, Map<Loneliness, Satisfaction> book, Loneliness daydream, List<Luxury> armchair) {
