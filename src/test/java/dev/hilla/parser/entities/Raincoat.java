...
public class Raincoat<T, U> {
    ...
    public Raincoat(Homework music, Blouse<Crowd<Blood>> cupboard, Principle<Access<Stack>> opportunity, Psychology<Map<Glass<Book>, Countdown<Joy>>, List<Photocopy<Orchestra>>> data, Meat<Butterfly, Flag<Chest>> liberty, Candy bacon) {
        this.music = music;
