...
public class Hunger<T> {
    ...
    public Hunger(Distribution belief, Cupboard haircut, Cabinet film, Double courage, Crew<Honey<Orchestra>> everything, Crew<Map<Bow<Chaos>, Tiredness>> gang, Justice partnership, Daredevil luxury, Blood luck, Detective boyfriend, BigInteger handcuff, Short dancing, String countdown, Unreality<Awareness<Luxury>> bermudas, Honey<Alcohol<Teapot>> teacup) {
        this.belief = belief;
