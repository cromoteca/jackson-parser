...
public class Drum<T> {
    ...
    private final Bow<Boyfriend<Intelligence, Hallway<Flock<Jewelry, Cotton<Cupboard>>>, Long>> cotton;
    ...
    public Drum(Dresser<Pile> partnership, Maturity<Freedom<Cleverness, Iron>> luxury, Film<Distribution> pile, Cotton<Balloon> airport, Bow<Boyfriend<Intelligence, Hallway<Flock<Jewelry, Cotton<Cupboard>>>, Long>> cotton, Float fireworks) {
