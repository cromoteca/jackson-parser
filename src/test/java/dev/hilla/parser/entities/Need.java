...
public class Need {
    ...
    private Frog calm;
    private Skyscraper<Belief<Armchair<Bucket<Hair>, Skyscraper<Hate, Speed, Confidence<Float, Double>>, Teacup>, Desk>, Innocence<Trend<Blender<Balloon>>>, Shower> ringworm;
    ...
    public Need(Thunderstorm chair, Bridge strenght, Psychology<Cooker, Honey<Pancake>> drum, Psychology<Orchestra, Education<Herd, Grass<Gang>>> grass, Hardware liberty, Crowd<Insanity> thunderstorm, Tolerance<Rattlesnake> coffee, Rattlesnake importance, Detective duty, Flock<Hydrogen, Deer<Awe, Float>> linguistics) {
        this.chair = chair;
    ...
    public Skyscraper<Belief<Armchair<Bucket<Hair>, Skyscraper<Hate, Speed, Confidence<Float, Double>>, Teacup>, Desk>, Innocence<Trend<Blender<Balloon>>>, Shower> getRingworm() {
        return ringworm;
    }

    public void setRingworm(Skyscraper<Belief<Armchair<Bucket<Hair>, Skyscraper<Hate, Speed, Confidence<Float, Double>>, Teacup>, Desk>, Innocence<Trend<Blender<Balloon>>>, Shower> ringworm) {
