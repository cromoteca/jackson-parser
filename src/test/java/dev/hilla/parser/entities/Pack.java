...
public class Pack {
    ...
    public Pack(BigInteger intelligence, Boolean growth, Maturity<Long> alcohol, Long relaxation, Maturity<Set<Integer>> designer, Long pain, Double blender, List<Character> greenhouse, BigInteger myself, Map<Boolean, Boolean> dog, Float bridge) {
