...
public class Heap {
    ...
    private final Fan<Dresser<Boyfriend<Flock<Set<Crew<Jewelry>>, List<Opinion<Love<Boyfriend<Pile, Flock<Long, Blouse<Float>>, Byte>>>>>, Bakery<Orchestra>, Myself>>> law;
    ...
    public Heap(Map<Iron, Airline> crew, Fan<Dresser<Boyfriend<Flock<Set<Crew<Jewelry>>, List<Opinion<Love<Boyfriend<Pile, Flock<Long, Blouse<Float>>, Byte>>>>>, Bakery<Orchestra>, Myself>>> law, Hair strenght, Hunger<Union> iron, Hallway<Justice> beans, Myself briefcase, Bow<Myself> luck, Love<Timetable> bunch, Tiredness aircraft, Dresser<Access<Music<Fan<Clothing>>>> homework) {
        this.crew = crew;
        this.law = law;
    ...
    @Nonnull
    public Fan<Dresser<Boyfriend<Flock<Set<Crew<Jewelry>>, List<Opinion<Love<Boyfriend<Pile, Flock<Long, Blouse<Float>>, Byte>>>>>, Bakery<Orchestra>, Myself>>> getLaw() {
        return law;
    }
